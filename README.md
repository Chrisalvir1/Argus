...
- **Sincronización Inteligente con Paneles Externos** (v2.0.27): Dispara y silencia automáticamente sirenas de cámaras u otras alarmas.
...
- **Fondos Personalizables Independientes por Perfil** (v2.0.27): Cada usuario puede tener su propio fondo.
