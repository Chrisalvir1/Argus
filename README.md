...
- **Sincronización Inteligente con Paneles Externos** (v2.0.28): Dispara y silencia automáticamente sirenas de cámaras u otras alarmas.
...
- **Fondos Personalizables Independientes por Perfil** (v2.0.28): Cada usuario puede tener su propio fondo.
