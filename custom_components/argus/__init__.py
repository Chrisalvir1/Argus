...
_VOICE_KEYS={"enabled":CONF_ARMING_VOICE_ENABLED,"tts_entity":CONF_ARMING_VOICE_TTS,"media_players":CONF_ARMING_VOICE_PLAYERS,"message_start":CONF_ARMING_VOICE_MESSAGE_START,"message_remaining":CONF_ARMING_VOICE_MESSAGE_REMAINING,"message_last":CONF_ARMING_VOICE_MESSAGE_LAST,"message_complete":CONF_ARMING_VOICE_MESSAGE_COMPLETE,"message_cancelled":CONF_ARMING_VOICE_MESSAGE_CANCELLED,"message_triggered":CONF_ARMING_VOICE_MESSAGE_TRIGGERED}
_VOICE_SCHEMA=vol.Schema({vol.Optional("enabled"):bool,vol.Optional("tts_entity"):str,vol.Optional("media_players"):[str],vol.Optional("message_start"):str,vol.Optional("message_remaining"):str,vol.Optional("message_last"):str,vol.Optional("message_complete"):str,vol.Optional("message_cancelled"):str,vol.Optional("message_triggered"):str},extra=vol.ALLOW_EXTRA)
