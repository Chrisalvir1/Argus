...
from .arming_policy_runtime import install_arming_policy_runtime
...
async def async_setup(hass:HomeAssistant,config:dict)->bool:
 hass.data.setdefault(DOMAIN,{});_load_yaml_voice(hass,config);install_homekit_runtime(hass);install_safety_runtime();install_arming_policy_runtime();install_homekit_keepalive();install_trigger_voice();install_sensor_state_runtime();await async_register_panel(hass);_async_register_websocket_once(hass);return True
