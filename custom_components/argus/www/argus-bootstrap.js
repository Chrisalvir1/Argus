...
import { applyFullscreenPolish } from './argus-fullscreen-polish.js?v=2.0.35';
import { applyMediaClient } from './media-client.js?v=2.0.35';
import { applyPremiumExperience } from './premium-experience.js?v=2.0.35';
import { applySecurityClient } from './security-client.js?v=2.0.35';
import { applyV2012AuditFixes } from './argus-v2013-audit-fixes.js?v=2.0.35';
import { applyPerformanceProfile } from './argus-performance-profile.js?v=2.0.35';
import { applyVisualContainerFixes } from './argus-visual-container-fixes.js?v=2.0.35';
import { applyCompleteContentFixes } from './argus-complete-content-fixes.js?v=2.0.35';
import { applyRuntimeVisualFixes } from './argus-runtime-visual-fixes.js?v=2.0.35';
import { applyBgSensorAvailabilityFixes } from './argus-bg-sensor-availability-fixes.js?v=2.0.35';
import { applyBatteryUiFixes } from './argus-battery-ui-fixes.js?v=2.0.35';
import { applyDeepRepair } from './argus-deep-repair.js?v=2.0.35';
import { applyLightCapabilityFixes } from './argus-light-capability-fixes.js?v=2.0.35';
import { applyPersonalizationToggleFix } from './argus-personalization-toggle-fix.js?v=2.0.35';
