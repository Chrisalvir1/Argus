import './argus-panel.js?v=2.0.31';
import { applyUiAuditFixes } from './argus-ui-audit-fixes.js?v=2.0.31';
import { applyGridPolish } from './argus-grid-polish.js?v=2.0.31';
import { applyFullscreenPolish } from './argus-fullscreen-polish.js?v=2.0.31';
import { applyMediaClient } from './media-client.js?v=2.0.31';
import { applyPremiumExperience } from './premium-experience.js?v=2.0.31';
import { applySecurityClient } from './security-client.js?v=2.0.31';
import { applyV2012AuditFixes } from './argus-v2013-audit-fixes.js?v=2.0.31';
import { applyPerformanceProfile } from './argus-performance-profile.js?v=2.0.31';
import { applyVisualContainerFixes } from './argus-visual-container-fixes.js?v=2.0.31';
import { applyCompleteContentFixes } from './argus-complete-content-fixes.js?v=2.0.31';
import { applyRuntimeVisualFixes } from './argus-runtime-visual-fixes.js?v=2.0.31';
