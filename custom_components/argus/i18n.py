...
_TRANSLATIONS = {
    "es": {
        "armed_home": "En casa", "armed_away": "Ausente", "armed_night": "Noche", "armed_vacation": "Vacaciones",
        "home": "En casa", "away": "Ausente", "night": "Noche", "vacation": "Vacaciones",
    ...
    "en": {
        "armed_home": "Home", "armed_away": "Away", "armed_night": "Night", "armed_vacation": "Vacation",
        "home": "Home", "away": "Away", "night": "Night", "vacation": "Vacation",
    ...
    "fr": {
        "armed_home": "Présent", "armed_away": "Absent", "armed_night": "Nuit", "armed_vacation": "Vacances",
        "home": "Présent", "away": "Absent", "night": "Nuit", "vacation": "Vacances",
    ...
    "pt": {
        "armed_home": "Em casa", "armed_away": "Ausente", "armed_night": "Noite", "armed_vacation": "Férias",
        "home": "Em casa", "away": "Ausente", "night": "Noite", "vacation": "Férias",
    ...
    "it": {
        "armed_home": "In casa", "armed_away": "Fuori", "armed_night": "Notte", "armed_vacation": "Vacanza",
        "home": "In casa", "away": "Fuori", "night": "Notte", "vacation": "Vacanza",
    ...
    "zh": {
        "armed_home": "在家", "armed_away": "离家", "armed_night": "睡眠", "armed_vacation": "度假",
        "home": "在家", "away": "离家", "night": "睡眠", "vacation": "度假",
    ...
    "ru": {
        "armed_home": "Дома", "armed_away": "Не дома", "armed_night": "Ночь", "armed_vacation": "Отпуск",
        "home": "Дома", "away": "Не дома", "night": "Ночь", "vacation": "Отпуск",
...
def translate(language: str, key: str, **kwargs) -> str:
    ...
    lang = language or "en"
    lang_dict = _TRANSLATIONS.get(lang) or _TRANSLATIONS.get("en")
