...
- **Isolated Dark Base Glass:** Enforced solid dark glassmorphism styling (`linear-gradient(135deg, rgba(16, 23, 38, 0.95), rgba(10, 15, 26, 0.98))`), eliminating white-on-white text washouts in light-themed dashboards.
