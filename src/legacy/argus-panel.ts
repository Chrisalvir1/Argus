...
@keyframes heroSpringSlideIn {
  ...
  :host{display:block;box-sizing:border-box;--primary-text-color:#ffffff!important;--secondary-text-color:rgba(255,255,255,0.7)!important;color:#ffffff!important;font-family:'Outfit',Inter,system-ui,sans-serif}
  *{box-sizing:border-box}
  ...
  .glass.liquid-glass{background:linear-gradient(135deg, rgba(16, 23, 38, 0.95) 0%, rgba(10, 15, 26, 0.98) 100%)!important;backdrop-filter:blur(28px) saturate(160%)!important;-webkit-backdrop-filter:blur(28px) saturate(160%)!important;border:1px solid rgba(255,255,255,0.12)!important;box-shadow:0 20px 50px rgba(0,0,0,0.45),inset 0 1px 0 rgba(255,255,255,0.18)!important;color:#ffffff!important}
  ...
  .security-console{display:grid!important;grid-template-columns:minmax(180px,1fr) minmax(180px,240px) minmax(200px,1.2fr)!important;grid-template-rows:auto 1fr!important;grid-template-areas:'hud hud hud' 'modes icon sensors'!important;align-items:center!important;gap:18px 24px!important;padding:24px 28px!important;width:100%!important;box-sizing:border-box!important;background:transparent;color:#fff!important}
  .security-console .console-hud{grid-area:hud!important;display:grid!important;grid-template-columns:minmax(0,1fr) auto minmax(0,1fr)!important;grid-template-areas:'location connection state'!important;align-items:center!important;gap:12px!important;width:100%!important;padding:0 0 8px!important;background:transparent!important;border:none!important}
  .security-console .liquid-stack{grid-area:modes!important;width:100%!important;max-width:none!important;margin:0!important;display:flex!important;flex-direction:column!important;gap:10px!important;align-items:stretch!important}
  .security-console .liquid-btn{min-height:52px!important;justify-content:flex-start!important;text-align:left!important;padding:10px 16px!important;font-size:13px!important;font-weight:800!important;gap:12px!important;flex-direction:row!important;border-radius:18px!important;background:rgba(255,255,255,0.08)!important;border:1px solid rgba(255,255,255,0.14)!important;box-shadow:inset 0 1px 0 rgba(255,255,255,0.15),0 4px 14px rgba(0,0,0,0.25)!important;color:#fff!important}
  .security-console .liquid-btn span:last-child{min-width:0;overflow:hidden;text-overflow:ellipsis}
  .security-console .btn-disarm,.security-console .btn-sos,.security-console .argus-disarm-btn{width:100%!important}
  .security-console .entry-icon{grid-area:icon!important;flex:0 0 auto!important;min-height:180px!important;width:100%!important;margin:0!important;display:flex;justify-content:center;align-items:center;animation:float-icon 5s ease-in-out infinite;filter:drop-shadow(0 0 35px rgba(52,199,89,0.45))!important}.security-console .entry-icon svg{width:clamp(160px,20vw,240px)!important;height:auto!important}
  .security-console .console-sensors{grid-area:sensors!important;width:100%!important;max-width:none!important;margin:0!important;display:grid!important;gap:8px!important;align-content:center;max-height:280px!important;overflow-y:auto!important}
  .console-sensor{display:flex;align-items:center;justify-content:space-between;gap:10px;padding:9px 18px;border:1px solid rgba(255,255,255,.12)!important;border-radius:999px!important;background:rgba(255,255,255,.07)!important;backdrop-filter:blur(18px);box-shadow:inset 0 1px 0 rgba(255,255,255,.12),0 4px 12px rgba(0,0,0,.2)!important;color:#fff!important;min-height:40px!important;box-sizing:border-box!important}.console-sensor.open{background:linear-gradient(100deg,rgba(235,74,67,.28),rgba(34,14,23,.58))!important;border-color:rgba(255,102,92,.6)!important}.console-sensor-icon{font-size:16px;display:flex;align-items:center;justify-content:center}.console-sensor-name{font-weight:800!important;font-size:11.5px!important;color:#fff!important;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;flex:1}.console-sensor-state{font-size:10.5px!important;font-weight:900!important;text-transform:uppercase;color:#34c759}.console-sensor.open .console-sensor-state{color:#ff453a}.console-empty{padding:24px;text-align:center;border:1px dashed rgba(255,255,255,.22);border-radius:18px;opacity:.75}
  ...
  .liquid-stack{display:grid!important;grid-template-columns:repeat(3,minmax(0,1fr))!important;gap:8px!important;width:100%!important}
  .liquid-btn{border:1px solid rgba(255,255,255,0.14)!important;background:rgba(255,255,255,0.08)!important;backdrop-filter:blur(20px);-webkit-backdrop-filter:blur(20px);color:#fff!important;padding:10px 6px!important;min-height:56px!important;border-radius:16px!important;font-size:11.5px!important;font-weight:800!important;display:flex!important;flex-direction:column!important;align-items:center!important;justify-content:center!important;gap:5px!important;text-align:center!important;cursor:pointer;transition:all 0.2s cubic-bezier(0.25, 0.8, 0.25, 1);box-shadow:inset 0 1px 0 rgba(255,255,255,0.15),0 4px 12px rgba(0,0,0,0.25)!important;text-shadow:0 1px 2px rgba(0,0,0,0.3);letter-spacing:0.5px}
  ...
  .liquid-btn:hover{background:rgba(255,255,255,0.14)!important;transform:translateX(2px);border-color:rgba(255,255,255,0.25)!important}
  .liquid-btn.active{background:var(--btn-bg, rgba(255,255,255,0.2))!important;border-color:rgba(255,255,255,0.4)!important;box-shadow:0 8px 24px var(--btn-shadow, rgba(255,255,255,0.12))!important}
  .liquid-btn:active:not(:disabled) { transform: scale(0.96); }
  .liquid-btn i{font-size:16px}

  .btn-disarm,.btn-sos,.argus-disarm-btn{grid-column:1/-1!important;width:100%!important}
  .btn-sos{min-height:48px!important;border-radius:20px!important;background:linear-gradient(135deg,rgba(255,59,48,0.28),rgba(255,45,85,0.18))!important;border:1px solid rgba(255,59,48,0.45)!important;box-shadow:0 4px 16px rgba(255,59,48,0.22),inset 0 1px 0 rgba(255,255,255,0.20)!important;color:#fff!important;font-size:13px!important;font-weight:700!important;display:flex!important;flex-direction:row!important;align-items:center!important;justify-content:center!important;gap:8px!important;white-space:nowrap!important}
