...
export interface DashboardResponse{entry_id?:string|null;entries:ArgusEntry[];current_profile?:ArgusProfile|null;ui:JsonObject;available_entities:ArgusEntity[]}
...
export interface ArgusRequestMap{
 ...
 'argus/save_automations':EntryScoped&{automations:unknown[]};
 'argus/get_automations':EntryScoped;
 'argus/get_media_players':Record<never,never>;
...
export interface ArgusResponseMap{
 ...
 'argus/save_automations':{success:true};
