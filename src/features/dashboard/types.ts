...
export interface ArgusWidgetDefinition { id:string; kind:ArgusWidgetKind; title:string; icon?:React.ReactNode; size:ArgusWidgetSize; minSize?:ArgusWidgetSize; maxSize?:ArgusWidgetSize; locked?:boolean; visible:boolean }
