# Release Notes: Argus Home Hub v2.0.26

Version 2.0.26 includes several user interface refinements and robustness improvements for mobile devices, originally introduced as experimental fixes and now integrated natively into the core dashboard.
