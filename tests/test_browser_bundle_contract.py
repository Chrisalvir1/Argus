...
class TestBrowserBundleContract(unittest.TestCase):
    ...
    def test_react_bundle_has_no_node_process_environment(self):
        bundle = (WWW / "react-dist" / "argus-dashboard-react.ts").read_text(encoding="utf-8")
    ...
    def test_native_panel_loads_before_react_editor(self):
        ...
        self.assertIn("import './argus-panel.ts?v=2.0.50'", bootstrap)
        self.assertIn(
            "import('./react-dist/argus-dashboard-react.ts?v=react-layout-3')",
            bootstrap,
        )
