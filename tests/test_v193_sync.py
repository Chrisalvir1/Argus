...
class TestV193ManifestVersion(unittest.TestCase):
    def test_manifest_version_current(self):
        ...
        self.assertEqual(manifest["version"], "2.2.7", "manifest.json version must be current")
    ...
    def test_bootstrap_cache_bust_version_is_current(self):
        ...
        with open(bootstrap_path, "r", encoding="utf-8") as f:
            content = f.read()
        self.assertIn("2.2.7", content, "argus-bootstrap.js must reference the current cache-bust version")
