...
class TestV193ManifestVersion(unittest.TestCase):
    def test_manifest_version_current(self):
        ...
        self.assertEqual(manifest["version"], "2.0.85", "manifest.json version must be current")
...
class TestV193BootstrapCacheBust(unittest.TestCase):
    def test_bootstrap_version_current(self):
        ...
        with open(bootstrap_path) as f:
            content = f.read()
        self.assertIn("2.0.85", content, "argus-bootstrap.js must reference the current cache-bust version")
