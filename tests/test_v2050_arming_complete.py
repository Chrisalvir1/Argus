"""v2.2.82 arming-wait completion and Aqara-safe open detection."""
...
class TestV2050ArmingComplete(unittest.TestCase):
    def test_version_is_2050(self):
        self.assertIn('VERSION = "2.2.88"', CONST)
        self.assertIn('"version": "2.2.88"', MANIFEST)
        self.assertIn("2.2.88", BOOTSTRAP)
